...
function AdminHome(props) {
    ...
    const saveNotes = () => {
        if ((username === "" || password === "")) {
            ...
            const post = { id: Math.floor(Math.random() * 1000 + 1), name: username, body: password };
            setNote([...note, post]);
            clearText();
    ...
    return (
        <>
            <div className="container mt-5 pt-5">
                ...
                <Link to="/Admin/Roles/View"><button className="btn btn-primary mx-2 active" role="button">
                    Manage Roles</button></Link>
                <Link to="/Admin/Roles/View"><button className="btn btn-primary mx-2" role="button" data-bs-toggle="button">
                    Manage Users</button></Link>
                <Link to="/Admin/Users/View"><button className="btn btn-success mx-2" role="button" data-bs-toggle="button">
                    Manage Address</button></Link>
                <Link to="/Admin/Roles/View"><button className="btn btn-success mx-2" role="button" data-bs-toggle="button">
                    Other Changes</button></Link>
                <br />
                <br />
                <br />
                <br />
