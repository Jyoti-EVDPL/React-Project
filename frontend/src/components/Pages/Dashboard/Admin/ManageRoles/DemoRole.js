...
function RoleAdd(props) {
    ...
    const saveNotes = async (e) => {
        const data = JSON.stringify({ role_name, role_desc, role_isactive, userinfo })
        console.log(data)
        ...
        // } else {
        //     e.preventDefault();
        //     console.warn("role_name,role_desc, role_isactive", role_name, role_desc, role_isactive)
        //     let result = await fetch('http://localhost:4000/auth/home/admin/add_roles', {
        //         method: 'post',
        //         body: JSON.stringify({ role_name, role_desc, role_isactive, userinfo }),
        //         headers: {
